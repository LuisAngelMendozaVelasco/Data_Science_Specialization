...
```{r}
galton <- read.csv(file.path("./data/galton.csv"))
```
...
x[2] <- x[1]+1; y[2] <- y[1]
x[3] <- x[2]; y[3] <- y[2]+.646
segments(x[1], y[1], x[2], y[2], col='green', lwd=4)
segments(x[2], y[2], x[3], y[3], col='green', lwd=4)
segments(x[1], y[1], x[3], y[3], col='green', lwd=4)
```
