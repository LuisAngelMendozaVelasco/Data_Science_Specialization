...
```{r}
blog <- readLines("./data/en_US.blogs.txt", skipNul=TRUE, warn=TRUE)
news <- readLines("./data/en_US.news.txt", skipNul=TRUE, warn=TRUE)
twitter <- readLines("./data/en_US.twitter.txt", skipNul=TRUE, warn=TRUE)
```
