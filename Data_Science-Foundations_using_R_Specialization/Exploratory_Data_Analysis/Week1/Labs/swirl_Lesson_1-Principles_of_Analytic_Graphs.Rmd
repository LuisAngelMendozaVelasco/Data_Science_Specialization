...
```{r}
library('jpeg')
fname <- paste("./data", "AirCln1.jpeg", sep="/")
...
```{r}
fname <- paste("./data", "AirCln2.jpeg", sep="/")
try(dev.off(), silent=TRUE)
plot.new()
plotArea = par('fig')
rasterImage(readJPEG(fname), plotArea[1], plotArea[3], plotArea[2], plotArea[4], interpolate=FALSE)
...
```{r}
fname <- paste("./data", "AirCln3.jpeg", sep="/")
try(dev.off(), silent=TRUE)
plot.new()
plotArea = par('fig')
rasterImage(readJPEG(fname), plotArea[1], plotArea[3], plotArea[2], plotArea[4], interpolate=FALSE)
...
```{r}
fname <- paste("./data", "MVData1.jpeg", sep="/")
try(dev.off(), silent=TRUE)
plot.new()
plotArea = par('fig')
rasterImage(readJPEG(fname), plotArea[1], plotArea[3], plotArea[2], plotArea[4], interpolate=FALSE)
...
```{r}
fname <- paste("./data", "MVData2.jpeg", sep="/")
try(dev.off(), silent=TRUE)
plot.new()
plotArea = par('fig')
rasterImage(readJPEG(fname), plotArea[1], plotArea[3], plotArea[2], plotArea[4], interpolate=FALSE)
...
```{r}
fname <- paste("./data", "Integ.jpeg", sep="/")
try(dev.off(), silent=TRUE)
plot.new()
plotArea = par('fig')
rasterImage(readJPEG(fname), plotArea[1], plotArea[3], plotArea[2], plotArea[4], interpolate=FALSE)
